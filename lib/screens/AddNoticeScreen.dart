          ...
          children: [
            Column(
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    Text("Add Notice", style: TextStyle(
                        fontSize: 30,
                  ...
                  child: Container(
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        String fileName = "notice_" + DateTime.now().millisecondsSinceEpoch.toString();
                        Reference refn = ref.child("notices");
                        ...
                        try {
                          ...
                          // FireRealtime.addNotice(context: context, fileName: fileName, title: title, desc: desc);
                        } catch (e) {
